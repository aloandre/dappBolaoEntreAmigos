...
async function register(req, res) {
    ...
    try {
        ...
        if (unlockResponse) {
            ...
            // tranfere 10 ether para a conta do usuário
            let sendFundsResponse = null;
            
            sendFundsResponse = await web3.eth.sendTransaction({from: "0x00a1103c941fc2e1ef8177e6d9cc4657643f274b", to: accountAddress, value: web3.utils.toWei("10", "ether")})
